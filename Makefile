...
all: mybloom
mybloom : main.cpp
	$(CC) main.cpp $(SRC_DIR)/dbOperation.cpp $(SRC_DIR)/dbDumper.cpp $(SRC_DIR)/bloom_value.cpp $(SRC_DIR)/node.cpp $(SRC_DIR)/bloomTree.cpp $(C_FLAGS) $(LIBS) -o $(OUT_DIR)/main $(INCLUDE) $(LIB_PATH)
